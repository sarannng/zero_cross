...
class _GameState extends State<Game> {
  ...
  fourFun() {
    if(lock4==true){
      ...
      setState(() {
        four = 'O';
        chance = false;lock4=false;
      });
      check();
    } else {
      setState(() {
        four = 'X';
        chance = true;lock4=false;
      });
      check();
    }
    }
  ...
  fiveFun() {
    if(lock5==true){
      ...
      setState(() {
        five = 'O';
        chance = false;lock5=false;
      });
      check();
    } else {
      setState(() {
        five = 'X';
        chance = true;lock5=false;
      });
      check();
    }
    }
  ...
  sixFun() {
    if(lock6==true){
      ...
      setState(() {
        six = 'O';
        chance = false;lock6=false;
        check();
      });
    } else {
      setState(() {
        six = 'X';
        chance = true;lock6=false;
      });
      check();
    }
    }
  ...
  sevenFun() {
    if(lock7==true){
      ...
      setState(() {
        seven = 'O';
        chance = false;lock7=false;
        check();
      });
    } else {
      setState(() {
        seven = 'X';
        chance = true;lock7=false;
      });
      check();
    }
    }
  ...
  eightFun() {
    if(lock8==true){
      ...
      setState(() {
        eight = 'O';
        chance = false;lock8=false;
        check();
      });
    } else {
      setState(() {
        eight = 'X';
        chance = true;lock8=false;
      });
      check();
    }
    }
  ...
  nineFun() {
    if(lock9==true){
      ...
      setState(() {
        nine = 'O';
        chance = false;lock9=false;
      });
      check();
    } else {
      setState(() {
        nine = 'X';
        chance = true;lock9=false;
      });
      check();
    }
    }
